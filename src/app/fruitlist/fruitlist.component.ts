...
export class FruitlistComponent {
  ...
  fruitlistdata = inject(FruitlistdataService); // damit kann auf die Service Datei zugegriffen werden.
  ...
  // wurde in "fruitlistdata.service.ts" verschoben
  /* fruitlist = [
  ...
  // Beispiel für Funktion zum ausloggen des Fruchtnamens.
  //  namelog(name:string) {
  //    console.log(name);    
  //  }

  // Funktion für Kommentar hinzuzufügen -> wurde ersetzt (siehe unten)
